...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	KEYMAP(
		...
		KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_LABK, KC_UP, KC_RABK, LT(2, KC_DEL), 
		KC_LCTL, KC_LGUI, KC_LALT, LT(1, KC_SPC), KC_SPC, KC_LEFT, KC_DOWN, KC_RGHT),
	...
	switch (id) {
		case 0:
			if (record->event.pressed) {
				return MACRO( D(LCTL), D(LALT), D(LSFT), T(W), U(LSFT), U(LALT), U(LCTL), END );
			}
			break;
	}
	return MACRO_NONE;
