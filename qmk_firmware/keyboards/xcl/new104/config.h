...
/* Device */
#define VENDOR_ID       0xDE33
#define PRODUCT_ID      0x7323
#define DEVICE_VER      0x0001
#define MANUFACTURER    Leo Deng
#define PRODUCT         new104
#define DESCRIPTION     104 layout with TrackPoint
...
#define MATRIX_ROW_PINS { F1, F0, D4, F5, F4, F6, F7, E6, C7, C6 }
#define MATRIX_COL_PINS { B6, D6, D7, B4, B5, B0, B1, B2, B3, B7, D0}
