...
const is31_led g_is31_leds[DRIVER_LED_TOTAL] = {
  // Set 1
  {0, C2_9}, {0, C2_10}, {0, C2_11}, {0, C2_12}, {0, C2_13}, {0, C2_14}, {0, C2_15},
  {0, C3_9}, {0, C3_10}, {0, C3_11}, {0, C3_12}, {0, C3_13}, {0, C3_14}, {0, C3_15},
  {0, C4_9}, {0, C4_10}, {0, C4_11}, {0, C4_12}, {0, C4_13}, {0, C4_14}, {0, C4_15},
  {0, C5_9}, {0, C5_10}, {0, C5_11}, {0, C5_12}, {0, C5_13}, {0, C5_14}, {0, C5_15},
  {0, C6_9}, {0, C6_10}, {0, C6_11}, {0, C6_12}, {0, C6_13}, {0, C6_14}, {0, C6_15},
  {0, C7_9}, {0, C7_10}, {0, C7_11}, {0, C7_12}, {0, C7_13}, {0, C7_14}, {0, C7_15},
  {0, C8_9}, {0, C8_10}, {0, C8_11}, {0, C8_12}, {0, C8_13}, {0, C8_14}, {0, C8_15},
  // Set 2
  {0, C8_8}, {0, C8_7},  {0, C8_6},  {0, C8_5},  {0, C8_4},  {0, C8_3},  {0, C8_2},
  {0, C7_8}, {0, C7_7},  {0, C7_6},  {0, C7_5},  {0, C7_4},  {0, C7_3},  {0, C7_2},
  {0, C6_8}, {0, C6_7},  {0, C6_6},  {0, C6_5},  {0, C6_4},  {0, C6_3},  {0, C6_2},
  {0, C5_8}, {0, C5_7},  {0, C5_6},  {0, C5_5},  {0, C5_4},  {0, C5_3},  {0, C5_2},
  {0, C4_8}, {0, C4_7},  {0, C4_6},  {0, C4_5},  {0, C4_4},  {0, C4_3},  {0, C4_2},
  {0, C3_8}, {0, C3_7},  {0, C3_6},  {0, C3_5},  {0, C3_4},  {0, C3_3},  {0, C3_2},
  {0, C2_8}, {0, C2_7},  {0, C2_6},  {0, C2_5},  {0, C2_4},  {0, C2_3},  {0, C2_2},
  {0, C1_8}, {0, C1_7},  {0, C1_6},  {0, C1_5},  {0, C1_4},  {0, C1_3},  {0, C1_2}
};
...
void matrix_scan_kb(void) {
  if (timer_elapsed(animation_timer) > TERRAZZO_ANIMATION_SPEED) {
    terrazzo_scroll_pixel(terrazzo_dir);
