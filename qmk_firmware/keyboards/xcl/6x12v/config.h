...
#define PRODUCT         Think84
#define DESCRIPTION     84 layout with TrackPoint
...
#define MATRIX_COL_PINS { B6,D6,D7,B4,B5,B0,B1,B2,B3,B7,D0,D1}
...
#define VIAL_KEYBOARD_UID {0x92, 0x23, 0xC0, 0x1A, 0x53, 0x6C, 0x7C, 0xAF}
